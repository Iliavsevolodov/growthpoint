(() => {
  ...
  style.textContent = `
    ...
    .hero{
      ...
      padding-top:clamp(112px,14vh,170px)!important;
      padding-bottom:clamp(52px,8vh,90px)!important;
    }
    .hero .eyebrow{margin-top:0!important}
    .hero h1{
      font-size:clamp(3.45rem,12vw,10rem)!important;
      line-height:.82!important;
      letter-spacing:-.075em!important;
      margin:clamp(18px,3vh,32px) 0 clamp(24px,4vh,42px)!important;
    ...
    @media(max-width:760px){
      ...
      .hero h1{
        font-size:clamp(3.35rem,18vw,5.7rem)!important;
